...
void DrawPartSunroofButton()
{
    ...
    puthz(65, 74, "天窗锁", 32, 47+32, LIGHTBLUE);
    ...
    puthz(65, 74+120, "微通风", 32, 47+32, LIGHTBLUE);
    ...
    puthz(65, 74+240, "热保护", 32, 47+32, LIGHTBLUE);
    settextstyle(8, 0, 2);
...
void DrawSunroofChangePart(int* num)
{
    ...
    {
        setfillstyle(1, GREEN);
        floodfill(220, 150, LIGHTBLUE);
        if(num[1] == 1)
        {
            floodfill(100, 150+120, LIGHTBLUE);
        }
        else if(num[1] == 2)
        {
            floodfill(220, 150+120, LIGHTBLUE);
        }
        if(num[2] == 1)
        {
            floodfill(100, 150+240, LIGHTBLUE);
        }
        else if(num[2] == 2)
        {
            floodfill(220, 150+240, LIGHTBLUE);
        }
        if(num[3])
        {
            setlinestyle(0, 0, 3);
